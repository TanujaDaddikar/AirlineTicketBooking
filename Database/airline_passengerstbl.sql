...
CREATE TABLE `passengerstbl` (
  ...
  `PNat` varchar(45) DEFAULT NULL,
  `PGen` varchar(45) DEFAULT NULL,
  `PPass` varchar(45) DEFAULT NULL,
...
INSERT INTO `passengerstbl` VALUES (1,'Tara','India','Female','IND1258749','Ajara','8864952315'),(2,'Rohini','Albania','Female','ALB1458264','Albanis','9768459815'),(3,'Ram','Angola','Male','ANG145867','Angola','8957694835');
...
-- Dump completed on 2023-02-06 16:14:34
